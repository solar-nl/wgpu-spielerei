                  ...
                  match command {
                      ...
                      Command::IncreaseVolume => {
                        if playback_volume < 1.0 {
                          playback_volume = playback_volume + 0.05;

                        }
                        playback_volume = playback_volume.clamp(0.0, 1.0);
                        println!("playback_volume: {}", playback_volume);

                        _music.set_volume(playback_volume);
